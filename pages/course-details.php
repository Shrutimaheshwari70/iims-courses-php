...
.ccd-hero-title{
  ...
  max-width:54rem;margin:0 0 .85rem;
}
.ccd-hero-sub{
  color:rgba(255,255,255,.78);
  font-size:clamp(.875rem,1.5vw,1.05rem);
  display:flex;flex-wrap:wrap;align-items:center;gap:.6rem .5rem;
...
.ccd-hero-actions{display:flex;flex-wrap:wrap;gap:.75rem;align-items:center}
.ccd-btn-brochure{
...
.ccd-statbar-item:last-child{border-right:none}
.ccd-statbar-num{
...
@media(max-width:600px){
  .ccd-statbar-item{border-right:none;border-bottom:1px solid var(--border)}
  .ccd-statbar-item:last-child{border-bottom:none}
}
...
@media(max-width:1023px){.ccd-body{grid-template-columns:1fr}}
...
.ccd-lead{
  ...
  line-height:1.8;font-size:1rem;margin:0 0 .9rem;
}
.ccd-lead:last-child{margin-bottom:0}
...
.ccd-highlight-label{font-size:.78rem;font-weight:600;color:var(--muted-foreground);margin-bottom:2px;}
.ccd-highlight-val{font-size:.95rem;font-weight:700;}
...
.ccd-eligibility-table tr:last-child td{border-bottom:none}
.ccd-eligibility-table tr:hover td{background:var(--muted)}
...
.ccd-sem-header:hover{background:var(--muted)}
.ccd-sem-label{font-weight:700;font-size:.95rem}
.ccd-sem-arrow{
  flex-shrink:0;transition:transform .3s;
  color:var(--muted-foreground);font-size:18px;
}
.ccd-sem.open .ccd-sem-arrow{transform:rotate(180deg)}
.ccd-sem-body{
  max-height:0;overflow:hidden;
  transition:max-height .35s ease,padding .35s ease;
  padding:0 1.25rem;
}
.ccd-sem.open .ccd-sem-body{max-height:400px;padding:.25rem 1.25rem 1.25rem}
.ccd-topics{display:flex;flex-wrap:wrap;gap:.45rem}
.ccd-topic{
  font-size:.75rem;padding:.32rem .8rem;
  border-radius:9999px;
...
.ccd-career-card:hover{transform:translateY(-3px);box-shadow:0 10px 28px rgba(0,0,0,.1)}
.ccd-career-icon{
  font-size:28px;margin-bottom:.5rem;
  color:var(--color-accent,#e25c2a);
  display:flex;align-items:center;justify-content:center;
}
.ccd-career-title{font-size:.875rem;font-weight:700;margin-bottom:.2rem}
.ccd-career-sal{font-size:.75rem;color:var(--color-accent,#e25c2a);font-weight:600}
...
.ccd-testimonial::before{
  ...
  color:var(--color-accent,#e25c2a);opacity:.2;
  font-family:Georgia,serif;
}
.ccd-testimonial__text{
  font-size:.925rem;color:var(--muted-foreground);
  line-height:1.75;font-style:italic;margin:0 0 .85rem;
}
.ccd-testimonial__author{display:flex;align-items:center;gap:.75rem}
...
.ccd-testimonial__name{font-weight:700;font-size:.875rem}
.ccd-testimonial__role{font-size:.75rem;color:var(--muted-foreground)}
...
.ccd-iim-card:hover{box-shadow:0 10px 32px rgba(0,0,0,.1);transform:translateY(-2px)}
.ccd-iim-thumb{
  width:4.5rem;height:4.5rem;
  border-radius:.65rem;object-fit:cover;flex-shrink:0;
}
.ccd-iim-name{font-weight:700;font-size:.95rem;margin-bottom:.15rem}
.ccd-iim-loc{font-size:.75rem;color:var(--muted-foreground);display:flex;align-items:center;gap:.25rem}
.ccd-iim-loc i{font-size:12px}
.ccd-iim-meta{display:flex;flex-wrap:wrap;gap:.4rem;margin-top:.45rem}
.ccd-iim-badge{
...
.ccd-compare-table th:first-child{border-radius:12px 0 0 0}
.ccd-compare-table th:last-child{border-radius:0 12px 0 0}
.ccd-compare-table td{
  padding:.8rem 1rem;
  border-bottom:1px solid var(--border);
  color:var(--foreground);line-height:1.55;
}
.ccd-compare-table tr:last-child td:first-child{border-radius:0 0 0 12px}
.ccd-compare-table tr:last-child td:last-child{border-radius:0 0 12px 0}
.ccd-compare-table tr:hover td{background:var(--muted)}
.ccd-compare-table .highlight{
  font-weight:700;color:var(--color-accent,#e25c2a);
}
...
.ccd-sidebar-card{
  ...
  box-shadow:0 4px 32px rgba(0,0,0,.08);padding:1.5rem;
}
.ccd-sidebar-title{font-size:1.15rem;font-weight:800;margin-bottom:.25rem}
.ccd-sidebar-sub{font-size:.8rem;color:var(--muted-foreground);margin-bottom:1rem;line-height:1.55}
.ccd-form{display:flex;flex-direction:column;gap:.85rem}
.ccd-field{display:flex;flex-direction:column;gap:.3rem}
.ccd-label{font-size:.75rem;font-weight:700;color:var(--muted-foreground);text-transform:uppercase;letter-spacing:.05em}
.ccd-input{
...
/* Sidebar info list */
.ccd-info-list{display:flex;flex-direction:column;gap:.6rem;margin-top:1.25rem}
.ccd-info-row{
  display:flex;justify-content:space-between;align-items:center;
  font-size:.85rem;padding:.5rem 0;
  border-bottom:1px solid var(--border);
}
.ccd-info-row:last-child{border-bottom:none}
.ccd-info-key{color:var(--muted-foreground);font-weight:500}
.ccd-info-val{font-weight:700;color:var(--foreground)}
...
.ccd-trust-item i{font-size:13px}
...
.ccd-rec-card:hover{box-shadow:0 10px 32px rgba(0,0,0,.1);transform:translateY(-3px)}
.ccd-rec-img{width:100%;height:130px;object-fit:cover}
.ccd-rec-body{padding:1.1rem}
.ccd-rec-cat{
  font-size:.65rem;font-weight:700;letter-spacing:.08em;
  text-transform:uppercase;color:var(--color-accent,#e25c2a);
  margin-bottom:.3rem;
}
.ccd-rec-name{
...
.ccd-rec-meta{font-size:.75rem;color:var(--muted-foreground)}
...
@keyframes ccdModalIn{from{opacity:0;transform:translateY(16px)}to{opacity:1;transform:none}}
.ccd-modal-close{
...
.ccd-modal-close:hover{background:var(--muted)}
.ccd-modal-h{font-size:1.3rem;font-weight:800;margin-bottom:.3rem}
.ccd-modal-sub{font-size:.875rem;color:var(--muted-foreground);margin-bottom:1.5rem;line-height:1.55}
...
#ccd-scroll-top.visible{display:flex}
#ccd-scroll-top:hover{transform:translateY(-2px)}
...
@media(max-width:640px){
  .ccd-hero{height:70vh}
  .ccd-body{padding:2rem 1rem 4rem}
  .ccd-left{gap:2rem}
  .ccd-rec-wrap{padding:0 1rem 4rem}
  .ccd-sidebar-card{position:static}
}
</style>
...
<section class="ccd-hero">
  ...
  <div class="ccd-hero-inner">
    ...
    <div class="ccd-hero-actions">
      <button class="btn btn-hero" style="font-size:.9rem" onclick="document.getElementById('ccd-modal').classList.add('open')">
        Apply Now
...
<div class="ccd-statbar">
  <div class="ccd-statbar-inner">
    ...
    <div class="ccd-statbar-item">
      <div class="ccd-statbar-num">4.8<i class="ti ti-star-filled" style="font-size:1rem;color:var(--color-accent,#e25c2a)"></i></div>
  ...
  <div class="ccd-left">
    ...
    <section class="reveal">
      ...
      <p class="ccd-lead">
        ...
        premier IIMs, it blends rigorous academics with industry exposure, live projects and global immersion programmes.
      </p>
    ...
    <section class="reveal">
      ...
      <div class="ccd-outcomes">
        ...
        <div class="ccd-outcome-item">
          <span class="outcome-check"><i class="ti ti-check" style="font-size:11px"></i></span>
          Navigate the global business landscape including international trade, cross-border negotiations and cultural intelligence
        </div>
        <div class="ccd-outcome-item">
          <span class="outcome-check"><i class="ti ti-check" style="font-size:11px"></i></span>
          Build a leadership brand and professional network through alumni mentorship, industry immersion and live consulting projects
        </div>
        <div class="ccd-outcome-item">
          <span class="outcome-check"><i class="ti ti-check" style="font-size:11px"></i></span>
    ...
    <section class="reveal">
      ...
      <p class="ccd-lead">
        Graduates of this programme are placed across top MNCs, startups and government organisations in the following roles:
      </p>
    ...
    <section class="reveal">
      ...
      <p class="ccd-lead">Choose from <?= count($iims) ?> IIMs offering this programme — each with its own unique campus culture, faculty strength and placement network.</p>
      <div class="ccd-iims-grid">
        <?php foreach ($iims as $iim): ?>
        <a href="college-details.php?slug=<?= urlencode($iim['slug']) ?>" class="ccd-iim-card">
          <img src="<?= htmlspecialchars($iim['image']) ?>" alt="<?= htmlspecialchars($iim['name']) ?>" class="ccd-iim-thumb" loading="lazy">
          <div>
            ...
            <div class="ccd-iim-meta">
              <span class="ccd-iim-badge"><i class="ti ti-star-filled" style="font-size:10px;color:#e25c2a"></i> <?= htmlspecialchars((string)($iim['rating'] ?? '')) ?></span>
...
<div class="ccd-rec-wrap">
  ...
  <div class="ccd-rec-grid">
    ...
    <a href="course-details.php?slug=<?= urlencode($r['slug']) ?>" class="ccd-rec-card reveal">
      <img
        src="<?= htmlspecialchars($r['image'] ?? '../assets/images/default-course.jpg') ?>"
...
>
  <div class="ccd-modal-box">
    ...
    <p class="ccd-modal-sub">Fill in your details — our counsellor will reach out within 24 hours with the next steps.</p>
