...
<style>
  ...
  .bd-toc-link:hover::before,
  .bd-toc-link.active::before {
    background: var(--accent);
  }

  /* CTA sidebar widget */
  .bd-cta-widget {
    background: linear-gradient(135deg, #1a3c6e, #0f2548) !important;
    border: none !important;
  }

  .bd-cta-widget .widget-label {
  ...
  .bd-share-btn--wa:hover {
    background: #25d36611;
    border-color: #25d366;
    color: #25d366;
  }

  .bd-share-btn--tw:hover {
    background: #1da1f211;
    border-color: #1da1f2;
    color: #1da1f2;
  }

  .bd-share-btn--li:hover {
    background: #0a66c211;
    border-color: #0a66c2;
    color: #0a66c2;
  }
...
<section class="bd-hero overflow-hidden">
  <img class="bd-hero__img object-fit-cover" src="../<?= ltrim($b['image'], '/') ?>"
    alt="<?= htmlspecialchars($b['title']) ?>" onload="this.classList.add('loaded')">
  <div class="bd-hero__overlay"></div>
  <div class="bd-hero__content d-flex flex-column text-white justify-content-center">
      ...
      <div class="bd-prose">
        ...
        <div class="row g-3 mb-4 align-items-stretch">
          <div class="col-4 d-flex">
            <div class="card border rounded-3 text-center p-3 w-100 d-flex flex-column justify-content-center">
        ...
        <p>
          ...
          vying for fewer than ten thousand seats across all IIMs combined, the selection process is rigorous,
          multi-layered
          and rewards <strong>consistent, structured preparation</strong> over last-minute sprints.
        </p>
        <p>
          This guide synthesises insights from recent IIM converts, admission consultants and academic coaches to give
          you
          a battle-tested roadmap — whether you're starting from scratch twelve months out or fine-tuning in the final
          lap.
        </p>
        ...
        <p>
          The Common Admission Test (CAT) is divided into three sections. Each demands a different mindset and
          preparation
        ...
        <p>
          VARC is the great differentiator at the 99th percentile. Most high scorers are strong in Quant but stumble
          here.
        ...
        <div class="bd-timeline">
          <div class="bd-timeline__item">
            ...
            <p class="bd-timeline__text text-muted">Master fundamentals in all three sections. Complete one standard
              book per topic. Begin daily reading habit. Attempt sectional tests weekly.</p>
          </div>
          <div class="bd-timeline__item">
            <div class="bd-timeline__month">Apr – Jun</div>
            <div class="bd-timeline__heading">Concept Deepening</div>
            <p class="bd-timeline__text text-muted">Focus on weak areas identified from sectional tests. Introduce
              advanced problem sets. Start the first full-length mock. Maintain a 100-word daily vocabulary log.</p>
          </div>
          <div class="bd-timeline__item">
            <div class="bd-timeline__month">Jul – Sep</div>
            <div class="bd-timeline__heading">Intensive Mock Phase</div>
            <p class="bd-timeline__text text-muted">Two mocks per week with rigorous analysis. Stabilise accuracy
              percentages. Work on time management and question prioritisation strategy.</p>
          </div>
          <div class="bd-timeline__item">
            <div class="bd-timeline__month">Oct – Nov</div>
            <div class="bd-timeline__heading">Peak Performance Sprint</div>
            <p class="bd-timeline__text text-muted">Three mocks per week. Focus entirely on consistency and exam
              temperament. Avoid new topics. Sleep and health are non-negotiable during this phase.</p>
          </div>
          <div class="bd-timeline__item">
            <div class="bd-timeline__month">Dec – Jan</div>
            <div class="bd-timeline__heading">WAT-PI Preparation</div>
            <p class="bd-timeline__text text-muted">Begin GD/WAT/PI coaching. Polish your SOP and academic profile.
              Research your target IIMs thoroughly — panelists appreciate informed candidates.</p>
          </div>
        </div>
        ...
        <p>
          ...
          beat elaborate vocabulary. Structure your essay as: <strong>Context → Your stand → Arguments →
            Counter-argument
            → Conclusion</strong>.
        </p>

        <h3>Personal Interview (PI)</h3>
        <p>The PI is a structured conversation about <em>you</em> — your academics, work experience, goals and
          worldview. Common themes across IIM panels include:</p>
        <ul class="bd-checklist">
        ...
        <p>IIMs increasingly weigh the holistic profile — work experience quality, extracurriculars, diversity of
          background and academic consistency. Here's what stands out in applications:</p>
        ...
        <p>
          Candidates with leadership roles in student bodies, published research, sports representation at
          state/national
      ...
      <div class="card border rounded-3 p-4 mb-4">
        <div class="d-flex gap-3">
          ...
          <div>
            ...
            <div class="mb-2" style="font-size:.8rem;color:var(--accent);font-weight:600;">Senior Admission Strategist
              &amp; CAT Mentor</div>
      ...
      <section class="mb-5">
        <h3 class="fw-bold mb-4" style="font-size:1.35rem;letter-spacing:-.02em;">
          <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none" stroke="currentColor"
            stroke-width="2" viewBox="0 0 24 24" style="display:inline;vertical-align:middle;margin-right:8px;">
        ...
        <div class="card border rounded-3 p-4 mb-4">
          <form method="POST" action="blog-details.php?slug=<?= urlencode($slug) ?>">
            <div class="row g-3 mb-3">
              ...
              <div class="col-12 col-sm-6">
                <input type="email" name="comment_email" class="form-control bd-input"
                  placeholder="Email (not published)">
              </div>
            </div>
            <div class="mb-3">
              <textarea name="comment_text" class="form-control bd-input" rows="4"
                placeholder="Share your thoughts, questions or experience…" required></textarea>
            </div>
            ...
            <li class="card border rounded-3 p-3">
              <div class="d-flex gap-3">
                ...
                <div class="flex-grow-1 min-w-0">
                  ...
                  <p class="mb-1 text-muted" style="font-size:.875rem;line-height:1.65;">
                    <?= htmlspecialchars($c['text']) ?></p>
                  <button class="btn btn-sm p-0 text-muted border-0" style="font-size:.78rem;"
                    onclick="this.textContent=this.textContent==='👍 Helpful'?'Helpful (1)':'👍 Helpful'">👍
                    Helpful</button>
                </div>
              </div>
            </li>
            ...
            <?php foreach ($loop as $r):
              ...
              <div class="bd-scroll-card">
                <a href="blog-details.php?slug=<?= urlencode($r['slug']) ?>" class="bd-rec-card card border">
                  <img src="<?= htmlspecialchars($imgPath) ?>" alt="<?= htmlspecialchars($r['title']) ?>"
                    class="bd-rec-card__img" loading="lazy">
                  <div class="p-3">
    ...
    <aside class="col-12 col-lg-4">
      <div class="d-flex flex-column gap-4 bd-sidebar-sticky">
        ...
        <div class="card border rounded-3 p-4">
          <div class="text-muted fw-bold mb-3" style="font-size:.8rem;text-transform:uppercase;letter-spacing:.1em;">In
            This Article</div>
        ...
        <div class="card rounded-3 p-4 bd-cta-widget text-center">
          <div class="widget-label fw-bold mb-3" style="font-size:.8rem;text-transform:uppercase;letter-spacing:.1em;">
            Get Expert Help</div>
        ...
        <!-- Share widget -->
        <div class="card border rounded-3 p-4">
          <div class="text-muted fw-bold mb-3" style="font-size:.8rem;text-transform:uppercase;letter-spacing:.1em;">
            ...
            foreach ($popular as $p):
              ...
              <a href="blog-details.php?slug=<?= urlencode($p['slug']) ?>" class="bd-popular-item">
                <img src="<?= htmlspecialchars($imgPath) ?>" alt="<?= htmlspecialchars($p['title']) ?>"
                  class="bd-popular-img" loading="lazy">
                <div>
        ...
        <!-- Newsletter widget -->
        <div class="card border rounded-3 p-4">
          <div class="text-muted fw-bold mb-2" style="font-size:.8rem;text-transform:uppercase;letter-spacing:.1em;">
            Stay Updated</div>
          <p class="text-muted mb-3" style="font-size:.85rem;line-height:1.6;">Get weekly IIM insights, CAT tips and
            admission alerts straight to your inbox.</p>
