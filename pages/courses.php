...
<section class="cp-hero">
  <div class="cp-hero-inner">
    ...
    <p class="cp-hero-sub">
      From flagship MBA to executive education, PGDM &amp; Business Analytics — find the right programme for your career
      leap.
    </p>
    ...
    <div class="trend-scroll" id="trend-scroll">
      ...
      foreach ($trendCourses as $idx => $tc):
        ...
        <div class="trend-card" onclick="window.location='course-details.php?slug=<?= urlencode($tc['slug']) ?>'">
          ...
          <div style="font-size:.68rem;color:var(--muted);margin-top:6px;font-weight:600;"><?= $pop ?>% interest score
          </div>
        </div>
      <?php endforeach; ?>
    </div>
  ...
  <div class="cp-container">
    ...
    <div class="cp-grid" id="cp-grid-container">
      <?php foreach ($COURSES as $i => $c): ?>
        ...
        <div class="cp-card" style="transition-delay:<?= min($i * 0.06, 0.54) ?>s" data-reveal
          data-title="<?= htmlspecialchars(strtolower($c['title'])) ?>" data-cat="<?= htmlspecialchars($c['category']) ?>"
  ...
  <div class="cp-container">
    ...
    <div class="career-grid">
      ...
      <div class="career-left">
        ...
        <p class="career-desc">IIM alumni command premium roles across consulting, finance, tech, and general
          management. Here's a snapshot of top placements.</p>
        ...
        <div class="career-role-list">
          ...
          foreach ($roles as $r):
            ...
            <div class="career-role">
              <div class="career-role-icon" style="background:<?= $r['bg'] ?>;color:<?= $r['color'] ?>;"><i
                  class="bi <?= $r['icon'] ?>"></i></div>
              <div>
