...
<div class="college-card h-100 overflow-hidden rounded-3 fade-up" style="animation-delay:<?= ($index ?? 0) * 0.06 ?>s">

  <!-- IMAGE -->
  <div class="college-card-img rounded-3 overflow-hidden">

    <img src="<?= htmlspecialchars($imgSrc) ?>" alt="<?= htmlspecialchars($college['name']) ?>" loading="lazy"
    ...
    <div class="college-card-actions">
      <!-- WISHLIST -->
      <a href="<?= $pageBase ?>wishlist.php?add=<?= urlencode($college['slug']) ?>"
      ...
      <?php if ($inCmp): ?>
        ...
        <a href="<?= $pageBase ?>compare.php?remove=<?= urlencode($college['slug']) ?>"
          class="cd-circle-btn active-compare" title="Remove from Compare">
      ...
      <?php else: ?>
        ...
        <a href="<?= $pageBase ?>compare.php?add=<?= urlencode($college['slug']) ?>" class="cd-circle-btn"
  ...
  <div class="college-card-body">
    ...
    <div class="college-card-footer">
      ...
      <a href="<?= $detailsLink ?>" class="btn btn-outline btn-sm text-dark border">
